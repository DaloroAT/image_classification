# From https://github.com/snorkel-team/snorkel/blob/master/snorkel/classification/loss.py
...
def cross_entropy_with_probs(
    ...
    """
    num_points, num_classes = inputs.shape
    # Note that t.new_zeros, t.new_full put tensor on same device as t
    cum_losses = inputs.new_zeros(num_points)
    for y in range(num_classes):
        target_temp = inputs.new_full((num_points,), y, dtype=torch.long)
        y_loss = F.cross_entropy(inputs, target_temp, reduction="none")
